...
class StoreStatusConsentimentoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'nome' => [
                ...
                'string',
                'max:255',
                Rule::unique('status_consentimentos', 'nome')->where('tenant_id', $tenantId),
            ],
            'slug' => [
                'required',
                'string',
                'max:255',
                Rule::unique('status_consentimentos', 'slug')->where('tenant_id', $tenantId),
            ],

...
const form = useForm({
    ...
    municipio_id: props.empresa.municipio_id,
    status_conflito_id: props.empresa.status_conflito_id,
    status_comercial_id: props.empresa.status_comercial_id,
    conflito_texto: props.empresa.conflito_texto,
    responsavel_user_id: props.empresa.responsavel_user_id,
});
...
const submit = (): void => {
    form
        ...
        .patch(update.url({ empresa: props.empresa.id }), {
            preserveScroll: true,
        });
};
</script>

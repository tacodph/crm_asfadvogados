...
import { update } from '@/actions/App/Http/Controllers/Admin/FinalidadeConsentimentoController';
...
const form = useForm({
    nome: props.finalidade.nome,
    slug: props.finalidade.slug,
    ordem: props.finalidade.ordem,
});
...
const submit = (): void => {
    form.patch(update.url({ finalidade: props.finalidade.id }), {
        preserveScroll: true,
    });
};
</script>

...
import {
    ...
    edit,
    store,
} from '@/actions/App/Http/Controllers/Admin/StatusComercialController';
...
const submit = (): void => {
    form.post(store.url(), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset('nome', 'slug', 'descricao');
...
const remove = (id: number): void => {
    ...
    router.delete(destroy.url({ status_comercial: id }), {
        preserveScroll: true,
    });
};
</script>
    ...
    <div class="mx-auto flex max-w-[980px] flex-col gap-4">
        <div class="flex flex-col gap-1">
            ...
            <p class="m-0 text-[13px] text-muted-foreground">
                Ciclo de vida compartilhado por contatos e empresas.
            </p>
        </div>

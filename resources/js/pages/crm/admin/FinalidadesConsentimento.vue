...
import {
    ...
    edit,
    store,
} from '@/actions/App/Http/Controllers/Admin/FinalidadeConsentimentoController';
...
const remove = (id: number): void => {
    if (!confirm('Excluir esta finalidade?')) {
        return;
    }

    router.delete(destroy.url({ finalidade: id }), { preserveScroll: true });
};
</script>
                    ...
                    >
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex justify-end gap-2">
                                <Link
                                    :href="edit.url({ finalidade: item.id })"

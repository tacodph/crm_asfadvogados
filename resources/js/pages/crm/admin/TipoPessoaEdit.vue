...
import { update } from '@/actions/App/Http/Controllers/Admin/TipoPessoaController';
import { index as tiposIndex } from '@/routes/admin/tipos-pessoa';
...
const form = useForm({
    ...
    slug: props.tipo.slug,
    ordem: props.tipo.ordem,
});
...
const submit = (): void => {
    form.patch(update.url({ tipo_pessoa: props.tipo.id }), {
        preserveScroll: true,
    });
};
</script>

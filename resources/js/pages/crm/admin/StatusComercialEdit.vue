...
import { update } from '@/actions/App/Http/Controllers/Admin/StatusComercialController';
import { index as statusIndex } from '@/routes/admin/status-comerciais';
...
const submit = (): void => {
    form
        ...
        .patch(update.url({ status_comercial: props.status.id }), {
            preserveScroll: true,
        });
};
</script>
        ...
        >
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea
                    ...
                    rows="3"
                    placeholder="Explique quando usar este status no cadastro de contatos e empresas."
                    :class="fieldClass"
                />
            </div>
